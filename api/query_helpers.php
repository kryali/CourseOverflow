...
function showHelp($error)
{
	...
	echo '<style type="text/css">table{width:800px;} th{width:25%;text-align:left;} td,th{padding-left:6px; padding-right:6px; vertical-align:top} #pagetitle{text-align:center} .error{color:red; font-weight:bold} #desc {padding-left:6px}</style>';
	echo '</head><body>';
	...
	echo '<tr><td>authenticate</td><td>bool</td><td>email</td><td>password</td></tr>';
	echo '<tr><td>submit_vote</td><td>bool</td><td>message_id</td><td>&nbsp;</td></tr>';
	...
	echo '<tr><td>subscribe_to_class</td><td>bool</td><td>fully_qualified_class_name</td><td>&nbsp;</td></tr>';
	echo '<tr><td>unsubscribe_from_class</td><td>bool</td><td>fully_qualified_class_name</td><td>&nbsp;</td></tr>';
